...
const getCurrentTimeSchema = z.looseObject({
	timezone: z.optional(z.string().describe("Optional timezone (e.g., 'America/New_York', 'Europe/London')")),
});

type GetCurrentTimeParams = z.output<typeof getCurrentTimeSchema>;
