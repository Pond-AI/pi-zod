...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@pond-ai/pi-coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@pond-ai/pi-tui";
import { z } from "zod";
